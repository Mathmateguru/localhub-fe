...
const UserContext = createContext({
  ...
  updateAuthentication: (status: boolean, newToken?: string, userInfo?: unknown) => {
    console.log(status, newToken,userInfo, 'updateAuthentication called');
  }
});
...
const UserProvider = ({ children }: UserContextProps) => {
  ...
  const updateAuthentication = (status: boolean, newToken?: string, userInfo?: unknown) => {
